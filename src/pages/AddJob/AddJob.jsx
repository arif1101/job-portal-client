...
const AddJob = () => {
    ...
    const handleAddJob = e => {
        ...
        console.log('main addJob data : ',initialData)
        ...
        .then(data => {
            if(data.insertedId){
                Swal.fire("Successfuly post a job!");
            };
            ...
            <form onSubmit={handleAddJob} className="card-body">
                ...
                <div className='flex gap-28'>
                    <div className="form-control">
                        ...
                        <select defaultValue="Pick a Job type" className="select select-ghost w-full max-w-xs bg-slate-100">
                    ...
                    <div className="form-control">
                        ...
                        <select defaultValue="Pick a Job Field" className="select select-ghost w-full max-w-xs bg-slate-100">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 items-end'>
                    ...
                    <div className="form-control">
                        <select defaultValue="Currency" name="currency" className="select select-ghost w-full max-w-xs bg-slate-100">
